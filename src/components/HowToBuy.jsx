...
const HowToBuy = () => {
  return (
    <div id="buy" className="max-w-340 mx-auto p-12">
      <div className="my-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-36 justify-items-center">
        <OrderCard order={1} title={"create a wallet"} style={"rotate-3"}>
          <span>
            ...
            or your{" "}
            <span className="bg-linear-to-r from-[#9945FF] to-[#14F195] inline-block text-transparent bg-clip-text uppercase font-extrabold text-2xl">
              Solana
            </span>{" "}
        ...
        <OrderCard order={3} title={"swap $Sol for $nubdog"} style={"-rotate-1"}>
          <span>
            Paste the token address (CA) into wallet and swap{" "}
            <span className="bg-linear-to-r from-[#9945FF] to-[#14F195] inline-block text-transparent bg-clip-text uppercase font-extrabold text-2xl">
              $SOL
            </span>{" "}
            for <span className="font-extrabold text-2xl text-duis">$NUBDOG</span>
